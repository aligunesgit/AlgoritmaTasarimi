...
??? question "macOS kullanıyorum, Flowgorithm çalışmıyor."

    Flowgorithm sadece Windows'ta çalışır ve derste isteğe bağlıdır. Akış şemaları için draw.io
    veya Mermaid kullanabilirsiniz.

??? question "`uv run pytest` hata veriyor."

    Önce `uv sync` komutunu repo klasörünün içinde çalıştırdığınızdan emin olun. Sorun devam ederse
    hata çıktısıyla birlikte ders sorumlusuna e-posta gönderin.
